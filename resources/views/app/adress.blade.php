            ...
            <main id="main-body" class="main-body col-md-9">
                <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                    ...
                    <section class="my-addresses">
                        ...
                        <form action="{{route('offlinePayment.index')}}">
                            @csrf
                        <button  class="my-address-wrapper mb-2 p-2">
                            <section class="mb-2">
                                <i class="fa fa-map-marker-alt mx-1"></i>
                                <input type="text" value="
                                آدرس : استان تهران، شهر تهران، تهران، خ. حافظ، پایینتر از تقاطع امام خمینی، بن. هشمی، پلاک 3، واحد 4" name="address1" class="invisible ">
                                <br>
                                آدرس : استان تهران، شهر تهران، تهران، خ. حافظ، پایینتر از تقاطع امام خمینی، بن. هشمی، پلاک 3، واحد 4
                            </section>
                            <section class="mb-2">
                    ...
                    <button class="my-address-wrapper mb-2 p-2">
                        ...
                        <section class="mb-2">
                            <i class="fa fa-map-marker-alt mx-1"></i>
                            <input type="text" value="
                            آدرس : استان تهران، شهر تهران، تهران، خ. پاسداران، کوچه غلامی پلاک 18، واحد 13" name="address1" class="invisible ">
                            <br>

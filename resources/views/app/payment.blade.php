                    ...
                    <section class="row mt-4">
                        <section class="col-md-9">
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                ...
                                <section class="payment-select">
                                    ...
                                    <form action="{{ route('orderRegistration',$cart) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    <input type="radio" name="paymentType" value="1" id="d1"/>
                                    ...
                                    <input type="radio" name="paymentType" value="2" id="d2"/>
                                    ...
                                    <input type="radio" name="paymentType" value="3" id="d3"/>
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                <section class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted">قیمت کالاها ({{$cartItemCount}})</p>
                                    <p class="text-muted">{{$total}} تومان</p>
                                </section>

                                <section class="d-flex justify-content-between align-items-center">
                                    <p class="text-muted">تخفیف کالاها</p>
                                    <p class="text-danger fw-bolder">0,000 تومان</p>
                                </section>
                                ...
                                <section class="">
                                    ...
                                    <button type="submit" id=""  class="btn btn-danger">ثبت سفارش و گرفتن کد رهگیری</button>
                                </section>
